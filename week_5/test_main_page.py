...
def test_guest_should_see_login_link(browser, link_main):
    page = BasePage(browser, link_main)
    page.open()
    page.go_to_login_page()                                                                                             # Переходим на страницу логина
...
def test_guest_cant_see_product_in_basket_opened_from_main_page(browser, link_main, empty_basket_message):
    page = BasePage(browser, link_main)
