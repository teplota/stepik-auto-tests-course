...
class UntitledTestCase2(unittest.TestCase):
    ...
    def test_untitled_test_case2(self):
        ...
        driver.find_element_by_id("id_registration-email").send_keys("asdfasdfadsf@afdsfs.ru")
        driver.find_element_by_id("id_registration-password1").clear()
        driver.find_element_by_id("id_registration-password1").send_keys("GfhjkmCkj;ysq111")
        driver.find_element_by_id("id_registration-password2").clear()
        driver.find_element_by_id("id_registration-password2").send_keys("GfhjkmCkj;ysq111")
